...
Welcome to the C++ Dojo. Here is a list of katas, easiest first:

1. [Prime Factors](/TDD/cpp/PrimeFactors/Step1.html)
2. [Roman Numerals](/TDD/cpp/RomanNumerals/Step1.html)
3. the [Bowling Game](/TDD/cpp/BowlingGame/BowlingGame.html) kata, three different ways
4. the [8 Queens problem](/TDD/cpp/EightQueens/Step1.html) kata
...
3. Clean up some [truly awful MSDN sample code](https://middleraster.github.io/TDD/cpp/RefactoringSockets/Step1.html)
4. [Refactor an 8 Queens solution](/TDD/cpp/RefactoringEightQueens/Step1.html)
