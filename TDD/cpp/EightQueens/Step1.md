...
The standard way to solve these kinds of problems (e.g., Sudoku, Knight's Tour problem, etc.) is with a recursive backtracking algorithm.
...
So, we need a way to break the problem down into something smaller.
