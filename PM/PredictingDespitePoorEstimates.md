...
- There are two more things to discuss:
   ...
   2. How to stay on track when the ship date *cannot* move
      ...
      Note that once the date is where it needs to be, that doesn't mean you won't discover so much more new (and more important) work, which may push out the ship date again, especially if the rate of discovery increases somewhat. In such a case, repeat the removal process.
