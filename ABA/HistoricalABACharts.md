...
Then I take the output of that and paste it into a spreadsheet that creates the chart. You can find that [here](https://middleraster.github.io/ABA/ABAChart.xlsx).
